...
export SAFE_LAUNCHER_VERSION=${SAFE_LAUNCHER_VERSION-"0.4.6"}
export SAFE_DEMO_APP_VERSION=${SAFE_DEMO_APP_VERSION-"0.2.3"}
export SAFE_VAULT_VERSION=${SAFE_VAULT_VERSION-"0.9.0"}
export SAFE_CORE_VERSION=${SAFE_CORE_VERSION-"0.15.1"}
